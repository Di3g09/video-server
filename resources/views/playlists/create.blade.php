        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl shadow-gray-200/50 rounded-2xl overflow-hidden border border-gray-100">
                ...
                <div class="p-6 sm:p-10">
                    <h3 class="text-lg font-medium text-gray-900 mb-6">Información de la playlist</h3>

                    <form action="{{ route('playlists.store') }}" method="POST" class="space-y-8">
                        @csrf
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" id="name"
                                           ...
                                           placeholder="Ej. Playlist general del día"
                                           required>
                                </div>
                                @error('name')
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <textarea id="description" name="description" rows="3"
                                              ...
                                              placeholder="Descripción breve de la playlist (opcional)">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
