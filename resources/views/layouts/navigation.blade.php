<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 sm:space-x-6">
                    ...
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            {{-- Aquí iremos agregando más altas (dispositivos, etc.) --}}
                            <x-dropdown-link :href="route('media-items.create')">
                                Alta de video
                            </x-dropdown-link>
                    ...
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            {{-- Aquí se agrupan todas las consultas/listados --}}
                            <x-dropdown-link :href="route('media-items.index')">
                                Videos
                            </x-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        {{-- Sección ALTAS en móvil --}}
        <div class="pt-2 pb-3 border-t border-gray-200 space-y-1">
            <div class="px-4 text-xs font-semibold text-gray-500 uppercase">
                Altas
            </div>
            <x-responsive-nav-link :href="route('media-items.create')" :active="request()->routeIs('media-items.create')">
                Alta de video
            </x-responsive-nav-link>
        ...
        {{-- Sección CONSULTAS en móvil --}}
        <div class="pt-2 pb-3 border-t border-gray-200 space-y-1">
            <div class="px-4 text-xs font-semibold text-gray-500 uppercase">
                Consultas
            </div>
            <x-responsive-nav-link :href="route('media-items.index')" :active="request()->routeIs('media-items.index')">
                Videos
            </x-responsive-nav-link>
